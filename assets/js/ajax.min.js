        ...
        $j('html, body').animate({scrollTop: 0}, 400, function () {
            if (animation === "ajax_updown" || animation === "ajax_updown_fade") {
                ...
                if (animation === "ajax_updown_fade") {
                    ...
                    content.stop().fadeTo(animationTime, 0, function () {
                        ...
                        $j('.content_wrapper').css({
                            visibility: 'visible',
                            opacity: 1
                        }).stop().animate({top: 0}, animationTime, function () {
                ...
                $j('.content_wrapper').css({
                    visibility: 'visible',
                    opacity: 1
                }).stop().animate({left: 0}, animationTime, function () {
                    $j('.content_wrapper').find('.content').unwrap();
                    perPageBindings();
                    anchorAjaxScroll(hash);
                    initElementsAnimation();
...
function loadResource(url) {
    ...
    $j.ajax({
        url: edgt_root + url, dataType: 'html', async: true, success: function (text, status, request) {
